...
uint8_t a_AdvData[18] =
{
  ...
  5, AD_TYPE_COMPLETE_LOCAL_NAME, 'S', 'T', 'O', 'P',  /* Complete name */
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0xC2, 0x03,
...
void APP_BLE_Send_Mouse_Data_Action(void){
  MOUSE_APP_Send_Data_Action();
}
